...
insert into servidor(idResponsavel, hostname, vulneravel) values (1, "porto", "nao");
insert into servidor(idResponsavel, hostname, vulneravel) values (1, "lisboa", "nao");
insert into servidor(idResponsavel, hostname) values (3, "evora");
insert into servidor(idResponsavel, hostname, vulneravel) values (2, "lagos", "nao");
insert into servidor(idResponsavel, hostname, vulneravel) values (3, "alu1", "nao");
insert into servidor(idResponsavel, hostname) values (1, "alu2");
insert into servidor(idResponsavel, hostname, vulneravel) values (2, "cica", "nao");
